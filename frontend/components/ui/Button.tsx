...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = "primary", size = "md", isLoading, children, disabled, ...props }, ref) => {
    const baseStyles =
      "inline-flex items-center justify-center font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/50 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950 disabled:pointer-events-none disabled:opacity-50 select-none active:scale-[0.97]";
    ...
    const variantStyles = {
      ...
      secondary:
        "bg-zinc-900/90 text-zinc-100 hover:bg-zinc-800 border border-zinc-800/80 shadow-sm hover:border-zinc-700",
      subtle:
        "bg-blue-500/10 text-blue-400 hover:bg-blue-500/20 border border-blue-500/20 hover:border-blue-500/30",
      outline:
        "border border-zinc-800 bg-transparent hover:bg-zinc-900 text-zinc-200 hover:border-zinc-700",
      ghost:
