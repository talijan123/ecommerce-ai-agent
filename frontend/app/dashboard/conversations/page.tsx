  ...
  return (
    <div className="flex-1 flex flex-col h-screen overflow-hidden">
      ...
      <div className="flex-1 flex overflow-hidden p-6 gap-6">
        ...
        <div className="w-80 sm:w-96 flex flex-col rounded-3xl border border-zinc-800/80 bg-zinc-950/90 overflow-hidden shadow-2xl">
          {/* Search Header */}
          <div className="p-3.5 border-b border-zinc-800/80 bg-zinc-900/60">
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-zinc-900 border border-zinc-800 rounded-xl pl-9 pr-4 py-2 text-xs text-white placeholder:text-zinc-500 focus:outline-none focus:border-blue-500"
              />
            </div>
          </div>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <Badge variant="default" className="text-[10px] py-0 px-2 font-mono">
        ...
        <div className="flex-1 flex flex-col rounded-3xl border border-zinc-800/80 bg-zinc-950/90 overflow-hidden shadow-2xl">
          {/* Header */}
          <div className="p-4 border-b border-zinc-800/80 bg-zinc-900/60 flex items-center justify-between">
            <div>
              ...
              <p className="text-[11px] text-zinc-400">Chronological history with tool-calling payloads</p>
            </div>
            {selectedSessionId && (
              <Button variant="outline" size="sm" onClick={() => fetchHistory(selectedSessionId)} className="text-xs gap-1.5">
          ...
          {/* Thread Body */}
          <div className="flex-1 p-6 overflow-y-auto space-y-4 custom-scrollbar bg-zinc-950/60">
            {loadingMessages ? (
                    ...
                    <div className={`max-w-[78%] space-y-2 ${isUser ? "order-1" : ""}`}>
                      ...
                      {msg.tool_calls && msg.tool_calls.length > 0 && (
                        <div className="p-3.5 rounded-2xl border border-blue-500/30 bg-blue-950/20 space-y-2">
                          ...
                          <pre className="p-2.5 rounded-xl bg-zinc-900 border border-zinc-800 font-mono text-[10px] text-blue-200 overflow-x-auto">
                      ...
                      {isTool && (
                        <div className="p-3.5 rounded-2xl border border-emerald-500/30 bg-emerald-950/20 space-y-2">
                          ...
                          <pre className="p-2.5 rounded-xl bg-zinc-900 border border-zinc-800 font-mono text-[10px] text-emerald-200 overflow-x-auto max-h-48">
                            {msg.content}
                          </pre>
                        </div>
                      )}
                        ...
                        <div
                          className={`rounded-2xl px-4 py-3 whitespace-pre-wrap leading-relaxed shadow-sm ${
                            isUser
                              ...
                              : "rounded-tl-sm bg-zinc-900 border border-zinc-800/90 text-zinc-200"
                          }`}
                        >
                          {msg.content}
                        </div>
                      ...
                      <span className="text-[10px] text-zinc-500 block px-1 font-mono">
